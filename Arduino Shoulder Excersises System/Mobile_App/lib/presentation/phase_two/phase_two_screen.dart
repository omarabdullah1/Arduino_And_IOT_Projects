...
import '../phase_one/phase_one_screen.dart';
import '../styles/colors.dart';

class PhaseTwoScreen extends StatelessWidget {
                    ...
                    children: [
                      Container(
                        ...
                        child: Column(
                          children: [
                            const Text(
                              'Phase 2 (6-12) weeks in scapular plane',
                            ),
                            const SizedBox(
                              height: 5.0,
                            ),
                            ...
                            SizedBox(
                              ...
                              child: PageView.builder(
                                ...
                                itemBuilder: (context, index) =>
                                    buildBoardingItem(
                                  phaseCubit.phaseTwo[index],
                                  context,
                                ),
                                itemCount: phaseCubit.phaseTwo.length,
                              ),
                            ),
              ...
              child: Row(
                ...
                children: [
                  SmoothPageIndicator(
                    ...
                    count: context.read<PhaseCubit>().phaseTwo.length,
                  ),
                  const SizedBox(
                    width: 20.0,
                  ),
