...
class PhaseThreeScreen extends StatelessWidget {
                            ...
                            SizedBox(
                              ...
                              child: PageView.builder(
                                ...
                                itemBuilder: (context, index) =>
                                    buildBoardingItem(
                                  phaseCubit.phaseThree[index],
                                  context,
                                ),
                                itemCount: phaseCubit.phaseThree.length,
                              ),
                            ),
              ...
              child: Row(
                ...
                children: [
                  SmoothPageIndicator(
                    ...
                    count: context.read<PhaseCubit>().phaseThree.length,
                  ),
                  const SizedBox(
                    width: 20.0,
                  ),
