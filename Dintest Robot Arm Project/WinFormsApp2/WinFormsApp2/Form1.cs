...
namespace WinFormsApp2
{
    public partial class Form1 : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                if (!(serialPort1.IsOpen))
                {
                    ...
                    serialPort1.BaudRate = 115200;
                    serialPort1.Open();
                    MessageBox.Show("OPEND SUCEESSFULLY.");
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            {
                serialPort1.Close();
                MessageBox.Show("CLOSED SUCEESSFULLY.");
        ...
        private void button17_Click(object sender, EventArgs e)
        {
            if (trackBar1.Value == 10)
            {
                SEND_MESSAGE_FUNC("-YStep" + "10");
                recordList.Add("-YStep10");

            }
            else if (trackBar1.Value == 20)
            {
                SEND_MESSAGE_FUNC("-YStep" + "100");
                recordList.Add("-YStep100");

            }
            else if (trackBar1.Value == 30)
            {
                SEND_MESSAGE_FUNC("-YStep" + "1000");
                recordList.Add("-YStep1000");
